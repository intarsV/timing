 ...
 */
public class ComboBoxItem<V> implements Comparable<ComboBoxItem>
{
    private V value;
     ...
     */
    public ComboBoxItem(V value, String description)
    {
        this.value = value;
     ...
     */
    public int compareTo(ComboBoxItem item)
    {
    ...
    {
        ComboBoxItem item = (ComboBoxItem)object;
