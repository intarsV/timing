...
public class GetGrandTotalGroupClassListService {
    ...
    public static void process(List<RaceResultList> list, CompetitionEvent event) {
        String reportUrlOneAndFour = "src/main/resources/reportTemplates/GrandTotalMergedGroupList.jrxml";
        String reportUrl = "src/main/resources/reportTemplates/GrandTotalGroup.jrxml";
