...
import lv.initex.report.singleReport.services.processList.GetGrandTotalGroupClassListService;
    ...
    public void execute() {
        ...
        if (eventIndex > 0) {
            ...
            if (boatClassIndex > 0) {
                ...
                GetGrandTotalGroupClassListService.generateReport(list, event);
            } else {
