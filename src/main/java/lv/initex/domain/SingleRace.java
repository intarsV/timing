...
public class SingleRace {
    ...
    public SingleRace(Vector row) {
        ...
        this.eventSingleRegistry = (EventSingleRegistry) row.get(28);
        this.competitionEvent = (CompetitionEvent) row.get(29);
        this.subEvent = (SubEvent) row.get(30);
        this.dsqr = (boolean) row.get(31);
        this.done = (boolean) row.get(32);
    }
